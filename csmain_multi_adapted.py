...
BOTS_CONFIG = {
    'wang': {
        'name': os.getenv('BOT_NAME', '老湿v1'),
        'api_id': os.getenv('API_ID'),
        'api_hash': os.getenv('API_HASH'),
        'bot_token': os.getenv('BOT_TOKEN'),
        'description': '第一个机器人实例 - 老湿v1',
        'version': os.getenv('BOT_VERSION', 'v1.0')
    },
    'tony': {
        'name': os.getenv('BOT_NAME', '老湿v2'),
        'api_id': os.getenv('API_ID'),
        'api_hash': os.getenv('API_HASH'),
        'bot_token': os.getenv('BOT_TOKEN'),
        'description': '第二个机器人实例 - 老湿v2',
        'version': os.getenv('BOT_VERSION', 'v2.0')
    },
    'YG': {
        'name': os.getenv('BOT_NAME', '老湿v3'),
        'api_id': os.getenv('API_ID'),
        'api_hash': os.getenv('API_HASH'),
        'bot_token': os.getenv('BOT_TOKEN'),
        'description': '第三个机器人实例 - 老湿v3',
        'version': os.getenv('BOT_VERSION', 'v3.0')
    }
}
